...
CTEST_DEFINE_EQUALITY_ASSERTION_FUNCTIONS_FOR_TYPE(ULONG,)
CTEST_DEFINE_EQUALITY_ASSERTION_FUNCTIONS_FOR_TYPE(ULONG64,)
CTEST_DEFINE_EQUALITY_ASSERTION_FUNCTIONS_FOR_TYPE(LONG,)
CTEST_DEFINE_EQUALITY_ASSERTION_FUNCTIONS_FOR_TYPE(LONG64,)
CTEST_DEFINE_EQUALITY_ASSERTION_FUNCTIONS_FOR_TYPE(HRESULT,)
